...
type LiveServerContent struct {
	...
	// If TurnComplete is zero value, then TurnComplete is either empty or zero value in
	// API response.
	...
	// If Interrupted is zero value, then Interrupted is either empty or zero value in API
	// response.
